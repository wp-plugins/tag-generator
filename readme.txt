...
2. Activate it.
3. Select language of your posts in Tools->Tag Generator->Prefences.
4. Start tagging all posts or select custom post for generate tags.
...
* Localize interface.
* Public plugin.
* Autoadd tags - it custum property
